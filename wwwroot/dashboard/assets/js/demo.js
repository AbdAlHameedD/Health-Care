...
demo = {
    ...
    initDashboardPageCharts: function (adminAccountsNumber, doctorAccountsNumber, patientAccountsNumber
        , appointmentsLabels, completedAppointments, waitingAppointments, cancelledAppointments,
        ...
        Chartist.Pie('#chartPreferences', {
            labels: [adminAccountsNumber + '%', doctorAccountsNumber + '%', patientAccountsNumber + '%'],
            series: [adminAccountsNumber, doctorAccountsNumber, patientAccountsNumber]
        });
